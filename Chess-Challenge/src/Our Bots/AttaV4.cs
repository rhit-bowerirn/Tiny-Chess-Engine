...
//PrincessAtta V4 with negamax 
//From this paper: https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=d1cd619d61d111947a46bf0bc34d7ee4018b8447
public class AttaV4 : IChessBot
{
    ...
    public Move Think(Board board, Timer timer)
    {
        ...
        double[] moveEvals = moves.Select(move => negamax(board, move, 6, double.MinValue, double.MaxValue)).ToArray();
